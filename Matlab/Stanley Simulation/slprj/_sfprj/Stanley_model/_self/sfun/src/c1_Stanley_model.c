...
static void sf_c1_Stanley_model(SFc1_Stanley_modelInstanceStruct *chartInstance)
{
  ...
  c1_tra_y = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  c1_tra_x = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  c1_start_index = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_cur_times = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c1_slope = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c1_curY = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c1_curX = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c1_cur_index = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  *chartInstance)
{
  ...
  c1_b_tra_y = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_tra_x = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 2);
  ...
  c1_b_slope = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_phi, 6U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_d, 7U, c1_d_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 9U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c1_slope, 10U, c1_c_sf_marshallOut);
  ...
  if (CV_EML_IF(0, 1, 0, c1_rec_index > 2.0)) {
    ...
    c1_perpen_vct1 = c1_tra_x[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_x", (int32_T)
      _SFD_INTEGER_CHECK("rec_index + 1", c1_rec_index + 1.0), 1, 3, 1, 0) - 1]
      - c1_tra_x[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_x", (int32_T)
      _SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) - 1];
    ...
    c1_vct_d1 = c1_tra_x[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_x", (int32_T)
      _SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) - 1] - c1_recX;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 19);
    c1_vct_d2 = c1_tra_y[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_y", (int32_T)
      _SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) - 1] - c1_recY;
    ...
    c1_phi = -c1_rec_angle + c1_slope[_SFD_EML_ARRAY_BOUNDS_CHECK("slope",
      (int32_T)_SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) - 1];
    ...
    c1_n_x = c1_t_y;
    c1_o_x = c1_n_x;
    c1_o_x = muDoubleScalarAtan(c1_o_x);
    c1_cur_angle = (c1_phi + c1_o_x) + c1_rec_angle;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 29);
    guard1 = FALSE;
    if (CV_EML_COND(0, 1, 0, c1_slope[_SFD_EML_ARRAY_BOUNDS_CHECK("slope",
          (int32_T)_SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) -
                    1] < 4.71238898038469)) {
      if (CV_EML_COND(0, 1, 1, c1_slope[_SFD_EML_ARRAY_BOUNDS_CHECK("slope",
            (int32_T)_SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0)
        ...
        c1_p_x = c1_line;
        c1_q_x = c1_p_x;
        c1_q_x = muDoubleScalarSign(c1_q_x);
        c1_q_a = c1_k;
        c1_o_b = c1_x;
        ...
        c1_t_x = c1_x_y;
        c1_u_x = c1_t_x;
        c1_u_x = muDoubleScalarAtan(c1_u_x);
        c1_r_a = c1_q_x;
        c1_p_b = c1_u_x;
        c1_y_y = c1_r_a * c1_p_b;
        c1_cur_angle = (c1_phi + c1_y_y) + c1_rec_angle;
      } else {
        guard1 = TRUE;
      }
    } else {
    ...
    if (guard1 == TRUE) {
      ...
      c1_v_x = c1_line;
      c1_w_x = c1_v_x;
      c1_w_x = muDoubleScalarSign(c1_w_x);
      c1_s_a = c1_k;
      c1_q_b = c1_x;
      ...
      c1_y_x = c1_x_x;
      c1_cb_y = c1_bb_y;
      c1_db_y = c1_y_x / c1_cb_y;
      c1_ab_x = c1_db_y;
      c1_bb_x = c1_ab_x;
      c1_bb_x = muDoubleScalarAtan(c1_bb_x);
      c1_t_a = c1_w_x;
      c1_r_b = c1_bb_x;
      c1_eb_y = c1_t_a * c1_r_b;
      c1_cur_angle = (c1_phi - c1_eb_y) + c1_rec_angle;
    }

    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 35);
    c1_cb_x = c1_cur_angle;
    c1_db_x = c1_cb_x;
    c1_db_x = muDoubleScalarCos(c1_db_x);
    c1_u_a = c1_v;
    c1_s_b = c1_db_x;
    c1_fb_y = c1_u_a * c1_s_b;
    c1_v_a = c1_fb_y;
    c1_gb_y = c1_v_a * 0.05;
    c1_curX = c1_recX + c1_gb_y;
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 36);
    c1_eb_x = c1_cur_angle;
    c1_fb_x = c1_eb_x;
    c1_fb_x = muDoubleScalarSin(c1_fb_x);
    c1_w_a = c1_v;
    c1_t_b = c1_fb_x;
    c1_hb_y = c1_w_a * c1_t_b;
    c1_x_a = c1_hb_y;
    c1_ib_y = c1_x_a * 0.05;
    c1_curY = c1_recY + c1_ib_y;
    ...
    if (CV_EML_IF(0, 1, 4, c1_rec_times != 0.0)) {
      ...
      c1_gb_x = c1_mpower(chartInstance, c1_recX -
                          c1_tra_x[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_x", (int32_T)
        _SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1, 0) - 1]) +
        c1_mpower(chartInstance, c1_recY - c1_tra_y[_SFD_EML_ARRAY_BOUNDS_CHECK(
        "tra_y", (int32_T)_SFD_INTEGER_CHECK("rec_index", c1_rec_index), 1, 3, 1,
        0) - 1]);
      c1_hb_x = c1_gb_x;
      if (c1_hb_x < 0.0) {
        c1_eml_error(chartInstance);
      ...
      c1_hb_x = muDoubleScalarSqrt(c1_hb_x);
      c1_d[0] = c1_hb_x;
      _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 40);
      c1_ib_x = c1_mpower(chartInstance, c1_recX -
                          c1_tra_x[_SFD_EML_ARRAY_BOUNDS_CHECK("tra_x", (int32_T)
        _SFD_INTEGER_CHECK("rec_index+1", c1_rec_index + 1.0), 1, 3, 1, 0) - 1])
      ...
      c1_jb_x = muDoubleScalarSqrt(c1_jb_x);
      c1_d[1] = c1_jb_x;
      ...
      c1_lb_x = c1_kb_x;
      c1_kb_y = c1_jb_y;
      c1_lb_y = c1_lb_x / c1_kb_y;
      if (CV_EML_IF(0, 1, 5, c1_lb_y < 0.33333333333333331)) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i16 = 0; c1_i16 < 2; c1_i16++) {
    (*(real_T (*)[2])c1_outData)[c1_i16] = c1_y[c1_i16];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2523582390U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(103365781U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3935015902U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(56159043U);
}
...
mxArray *sf_c1_Stanley_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9KtKyvhe33Bf7zw8TTobgD");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1983);
        _SFD_CV_INIT_EML_IF(0,1,0,177,213,405,1982);
        _SFD_CV_INIT_EML_IF(0,1,1,414,433,-1,554);
        _SFD_CV_INIT_EML_IF(0,1,2,775,799,938,1064);
        _SFD_CV_INIT_EML_IF(0,1,3,1252,1314,1381,1455);
        _SFD_CV_INIT_EML_IF(0,1,4,1547,1566,-1,1915);
        _SFD_CV_INIT_EML_IF(0,1,5,1836,1856,-1,1907);

        {
          static int condStart[] = { 1257, 1288 };

          static int condEnd[] = { 1282, 1312 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1256,1313,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c1_Stanley_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3642872731U));
  ssSetChecksum1(S,(870676254U));
  ssSetChecksum2(S,(3832901231U));
  ssSetChecksum3(S,(908560591U));
